...
public class LoginToPageWrongInput {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 *  id, name, class name, tag name, linkText, partial Link Text, xpath, css
		 *  
		 *  By: is a class
		 *  By.name();
		 *  By.xpad();
		 ...
		 */
			...
			usernameElement.sendKeys("operator"); // wrong user name entry.
